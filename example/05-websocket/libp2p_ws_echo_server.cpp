...
int main(int argc, char **argv) {
  ...
  auto log = libp2p::log::createLogger("WsServer");
  ...
  server.io_context->post([host{std::move(server.host)}, log] {
    auto ma = libp2p::multi::Multiaddress::create("/ip4/127.0.0.1/tcp/40010/ws")
                  .value();
    ...
    log->info("Connection string: {}/ipfs/{}", ma.getStringAddress(),
