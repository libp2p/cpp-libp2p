...
OUTCOME_CPP_DEFINE_CATEGORY(libp2p::protocol::kad, RoutingTableImpl::Error,
                            e) {
  using E = libp2p::protocol::kad::RoutingTableImpl::Error;
...
namespace {
  using libp2p::protocol::kad::Bucket;
