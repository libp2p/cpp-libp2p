...
#include <libp2p/protocol/kad/content_address.hpp>
...
namespace std {
  ...
  std::size_t hash<libp2p::protocol::kad::ContentAddress>::operator()(
      const libp2p::protocol::kad::ContentAddress &x) const {
    size_t h = 0;
