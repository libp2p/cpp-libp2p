...
#ifndef LIBP2P_PROTOCOL_GOSSIP_STREAM_READER_HPP
#define LIBP2P_PROTOCOL_GOSSIP_STREAM_READER_HPP
...
namespace libp2p::protocol::gossip {
  ...
  /// Reads RPC messages from connected stream
  class StreamReader : public std::enable_shared_from_this<StreamReader> {
   public:
    ...
    StreamReader(const Config &config, Scheduler &scheduler,
...
#endif  // LIBP2P_PROTOCOL_GOSSIP_STREAM_READER_HPP
