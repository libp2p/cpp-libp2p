...
namespace libp2p::multi {
  ...
  void Multistream::initBuffer(std::string_view protocol_path,
    ...
    multistream_buffer_.insert(multistream_buffer_.end(), new_length_bytes.begin(), new_length_bytes.end());
    multistream_buffer_.insert(multistream_buffer_.end(), protocol_path.begin(), protocol_path.end());
    multistream_buffer_.push_back('\n');
    multistream_buffer_.insert(multistream_buffer_.end(), data.begin(), data.end());
  }
